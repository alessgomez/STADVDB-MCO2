    ...
    .then(async result => {
       try {
          ...
          .then(async data => {
             ...
             logDb[0].query(`INSERT INTO log(transaction_no, row_no, col_name, old_value, new_value, query) VALUES (${transacNo}, ${req.params.id}, 'title', '${data.title}', '${req.body.title}', '${query}')`)
             .then(result => {
                db[0].query(query)
                .then(data => {
                      ...
                      try {
                         ...
                         .then(async result => {
                            try {   
                               ...
                               const query = `UPDATE movies SET title = ${req.body.title} WHERE id = ${req.params.id}`;
                               logDb[slaveInd].query(`INSERT INTO log(transaction_no, row_no, col_name, old_value, new_value, query) VALUES (${transacNo}, ${req.params.id}, "title", ${data.title}, ${req.body.title}, ${query})`)
                               .then(result => {
